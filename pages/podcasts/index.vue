      ...
      <div class="flex gap-6 xs:gap-8 sm:grid sm:grid-cols-8">
        <div class="w-[88px] shrink-0 sm:col-span-2 sm:w-auto">
          <NuxtLink
            ...
            class="block text-slate-400 hover:text-slate-600 hover:no-underline dark:text-neutral-500 dark:hover:text-neutral-300">
            &#9654;
          </NuxtLink>
        </div>
        ...
        <div class="grid gap-6 sm:col-span-6">
          <div>
            <h3 class="dark:text-neutral-100">
          ...
          <div v-if="podcast.recommendedEpisodes.length" class="grid gap-4">
            ...
            <div
              ...
              <button
                ...
                class="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-slate-200 text-slate-400 transition-colors hover:border-slate-400 hover:text-slate-600 dark:border-neutral-700 dark:text-neutral-500 dark:hover:border-neutral-500 dark:hover:text-neutral-300"
              ...
              <!-- Episode info -->
              <div class="min-w-0">
                <p class="text-sm leading-snug dark:text-neutral-100">{{ episode.title }}</p>
                <p class="mt-1 text-sm text-slate-400 dark:text-neutral-500">{{ episode.note }}</p>
              </div>
            </div>
          </div>
