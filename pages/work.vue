...
lg:mx-0">
    ...
    <section
      ...
      <div
        ...
        <small class="text-xs text-slate-400 uppercase">GoMore, 2019</small>
        <p>
    ...
    <section
      ...
      <div
        ...
        <small class="text-xs text-slate-400 uppercase">GoMore, 2018</small>
    ...
    <section
      ...
      <div
        class="mb-10 grid gap-3 sm:col-span-8 md:col-start-2 lg:col-start-3 lg:mb-14 xl:sticky xl:top-16 xl:col-span-4 xl:col-start-1 xl:mb-0">
        <h2>Blog redesign</h2>
        <small class="text-xs text-slate-400 uppercase">Regnsky, 2016</small>
    ...
    <section
      ...
      <div
        ...
        <small class="text-xs text-slate-400 uppercase">Research, 2016</small>
        <p>
