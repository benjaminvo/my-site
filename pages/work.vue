  ...
  <main
    ...
    <!-- <section
      ...
      <div
        ...
        <small class="text-xs uppercase text-slate-400 dark:text-neutral-500">Concept, 2016</small>
        <p>
...
<script setup>
useSeoMeta({
  title: "Work | Benjamin Ottensten, Product lead & Designer",
  ogTitle: "Work | Benjamin Ottensten, Product lead & Designer",
});
